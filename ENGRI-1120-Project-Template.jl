...
html"""
<p style="font-size:20px;">Rho Gamma Delta Nu: Alan Gansky, Jack Lenz, Patrick Schlaeppi, Quentin Camacho</br>
...
md"""
### Introduction
Rho Gamma Delta Nu out of Olin Engineering has been contracted to design and analyze a sustainable bioprocess to manufacture 1,2 Propandiol Dinitrate, using sucrose and specially designed cell-free bioreactors. 1,2 Propandiol Dinitrate better known as PGDN is a flammable, toxic explosive that produces H2O, CO and N2 when burned. It has a few potential uses including, propellant for otto fuel, fuel for torpedoes in the navy, and treatment for angina pectoris (squeezing pain in the chest/heart). To manufacture PGDN, sucrose, oxygen and potassium nitrate were used, sucrose and oxygen in one stream and potassium nitrate in the Sucrose is table sugar, it is used in everyday products such as baked goods, or as a sweetening agent in soda or food. Potassium Nitrate is a salt that is a strong oxidizer, it is used in making gunpowder, fertilizer, and medicine. Oxygen is the second most abundant gas in the atmosphere. 

https://pubchem.ncbi.nlm.nih.gov/compound/Potassium-nitrate#:~:text=Potassium%20Nitrate%20is%20a%20crystalline,and%20an%20inorganic%20nitrate%20salt
https://pubchem.ncbi.nlm.nih.gov/compound/Propylene-glycol-dinitrate#section=Uses  
...
We used an E. coli cell-free system, specially designed well-mixed reactors that were $100 per unit with a liquid volume of 100 𝞵L in which the cell-free components are stuck to the reactor. The reactors have two input streams and a single outlet stream. Through the first stream we ran oxygen and sucrose, and through the second we ran potassium nitrate. We separated unreacted starting materials from final products using specially fabricated universal separator units developed by Varnerlab that were $20 each-however, they are only 75% efficient by mass. The reactor units are fed by syringe pumps. We utilized two-channel syringe pumps  for $1000 per pump, assuming that the pumps have negligible power consumption and could be fed by infinite volume syringes. 
...
begin
	...
	mol_flow_values_feed_1 = [
		...
		1.05686 ; # sucrose mmol/hr (maybe: 0.822 or 6.1?)
...
# ╔═╡ 61ecb233-820f-443e-96a9-6fa1b2a8a987
number_of_chips = 7
...
Through our usage of 7 reactors and 4 separators, we were able to successfully design a continuous production process that produces a 95.8876% pure target molecule by mass stream at a rate of 1.2614 g/per hour. Our project had a cost of $30,688, our biggest cost was for the reactant Potassium Nitrate at $2.87/hr of the reactor. Our reactants total cost was $3.30/hr. Our gross profit of just PGDN was only $1.87/hr, however, by selling the other products we get from the reactions including our most price efficient Isoprene at $10.71/hr and CO2 at $12.62/hr, our total product's gross profit was $33.41/hr, and we were able to make a net profit of $261,984. In a full year we would produce 11,037.6 grams of product(PGDN) and so we made $23.74/g-of-product.
"""

# ╔═╡ ab9084e1-57a2-4c6b-ad32-8fee8c142c43
md"""
### Conclusions
In this reaction, we made a product of PGDN at 1.26 g/hr using the reactants sucrose, potassium nitrate, and oxygen. In addition to PGDN, the reaction had products of carbon dioxide, hydrogen, potassium hydroxide, and isoprene. The total cost going into the reaction per hour was $3.30 with a profit per hour of $33.41 with all available excess products being sold. The process is feasible and is recommended with the reaction far out producing the expected return on investment for the money invested with even a 10% yearly interest. This is seen in our NPV value being 620 for 10% and 739 for the 1%.
